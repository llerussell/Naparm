...
// Generate a hologram
__declspec( dllexport ) int GenerateHologram(float *h_checkData, uint8_t *h_pSLM_uc, float *x_spots, float *y_spots, float *z_spots, float *I_spots, int N_spots, int N_iterations, float *h_Iobtained, int method);
