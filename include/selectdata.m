...
params.Fill = 'on';
params.FillColor = [.5 .5 1];
params.FillEdgeColor = [.5 .5 1];
...
oldWindowButtonMotionFcn = get(fighandle,'WindowButtonMotionFcn');
oldWindowButtonUpFcn = get(fighandle,'WindowButtonUpFcn');
...
function selectdone(src,evnt) %#ok
  ...
  set(fighandle,'WindowButtonMotionFcn',oldWindowButtonMotionFcn);
  set(fighandle,'WindowButtonUpFcn',oldWindowButtonUpFcn);
